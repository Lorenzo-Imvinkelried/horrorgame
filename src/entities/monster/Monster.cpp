                     ...
                     bool isFlashlightOn) 
{
    ...
    if (glm::distance(playerPos, m_antiCampCenter) > 4.0f) {
        ...
        if (m_antiCampTimer > 6.0f) {
            // El jugador estÃ¡ campeando o dando vueltas en el mismo lugar
            m_confidence = 1.0f; // Furia mÃ¡xima
            m_stress = 0.0f;
    ...
    // --- 4. UTILITY SCORING ---
    {
        ...
        // Evitar que la IA aborte la acciÃ³n si estÃ¡ subida a un Ã¡rbol (evita teletransportes al suelo)
    ...
    switch (m_action) {
        ...
        case MonsterAction::CHASE: {
            ...
            // 1. IntercepciÃ³n predictiva (calcula dÃ³nde va a estar el jugador)
            ...
            // 2. Efecto Slender: Si no lo estÃ¡s mirando, corre MUCHO mÃ¡s rÃ¡pido
            if (!isVisibleToPlayer) {
            ...
            // 3. Zigzag defensivo: Si me estÃ¡s apuntando o en Blood Rage, serpenteo para que falles
            if ((isAimedAt || m_isEnraged) && distToPlayer > 4.0f) {
                ...
                // Alta frecuencia de zigzag impulsada por el estrÃ©s del monstruo, even higher if enraged
